...
},
{
  ...
  "body": " Section 1.1- What can we expect     Motivation: The Grand Rapids Children's Museum charges $12 admission for adults and $5 admission for children (ages 3-17). One day, they know the revenue was $900 and the total number of people was 110, but your boss isn't sure how many children and how many adults. Is there only one answer? Can you figure it out?      What is a line? What is a linear equation? Try to think both algebraically and geometrically (on a graph)! (Save this answer - we'll come back to it.)        We'll now consider linear systems in two variables: By a system of linear equations or a linear system , we mean a set of linear equations written in a common set of unknowns.     In the motivation, we saw a \"linear system\" in two variables, e.g., and . This is a linear system in the two variables and . We can visualize a linear system in two variables as a collection of lines in the plane. A solution to the linear system is a point that satisfies both equations, which is the same as saying where the two lines intersect. Here are the ways we say that lines can intersect.    A pair of lines that intersect in a single point, demonstrating that a set of linear equations may contain a single common solution.              Two parallel lines are shown, which demonstrates the fact that a set of two equations in two unknowns may have no solutions.             A pair of lines that intersect in infinitely many points, demonstrating that a set of linear equations may contain infinitely many common solutions.             Are there any other ways lines could intersect? Based on your answer, what are the possibilities for the solutions of a system of linear equations in two variables? Note we call the intersections the solution set to the linear system.       Based on the image below and prior knowledge - what happens to the number of solutions as we add more equations?    A single line, which contains infinitely many points. This demonstrates that a set of linear equations may have infinitely many solutions.    f(x) = x+1          A pair of lines that intersect in a single point, demonstrating that a set of linear equations may contain a single common solution.    f(x) = x+1  g(x) = 2*x-1           Three lines that have no common point of intersection. This shows that a set of linear equations may have no common solutions.    f(x) = x+1  g(x) = 2*x-1  h(x) = -1*x                   We'll now consider linear systems in three variables. An example of a linear equation in three variables is . A linear equation in three variables (think , , and ) is a plane. Here we'll use index cards, or pieces of paper, or whatever you have that looks like a flat surface, to study the solutions to systems of linear equations in three variables. Again, a solution to a system of linear equations is a point (or points) that satisfy all the equations, ie., an intersection.     Is it possible that there are no solutions to a system of two equations in three variables? If so, explain how or sketch an example.      Is it possible that the solutions to a system of two equations in three variables is a single point? If so, explain how or sketch an example.      If you are studying a system of two equations in three variables, what would you usually expect for the solution set?      If you are studying a system of three equations in three variables, what would you usually expect for the solution set?      If you are studying a system of four equations in three variables, what would you usually expect for the solution set?      Is it possible that the solutions to four equations in three unknowns form a line? Either sketch an example or state a reason why it can't happen.      Suppose we have a set of 500 linear equations in 10 unknowns. Which of the would you expect to hold?      Suppose we have a set of 10 linear equations in 500 unknowns. Which of the three possibilities would you expect to hold?      What happens to the size of the solution sets as we add more equations?         A linear equation in the unknowns may be written in the form where are real numbers knowns as coefficients . We also say that are the variables in the equation.  By a system of linear equations or a linear system , we mean a set of linear equations written in a common set of unknowns.      A solution to a linear system is simply a set of numbers that satisfy all the equations in the system.      Consider the above important definitions from your textbook when thinking about the following problems:     Which of the following equations are linear? Justify your response.                                  Consider the system of linear equations:        Is a solution?      Is a solution?      Is a solution?      Can you find a solution in which ?      Do you think there are other solutions?         Make sure you can answer the following questions (at least for 2 and 3 variables):     What is a linear equation?    What is a system of linear equations? What does it mean for a list of numbers to be a solution to a system of linear equations? Can you answer the second question both algebraically and geometrically?    How many solutions can we expect for a system of linear equations?    How does this number of solutions typically change as we add more equations?     "
},
{
  "id": "activities-4-2-1",
  "level": "2",
  ...
  "number": "1",
  "title": "",
  "body": "  Motivation: The Grand Rapids Children's Museum charges $12 admission for adults and $5 admission for children (ages 3-17). One day, they know the revenue was $900 and the total number of people was 110, but your boss isn't sure how many children and how many adults. Is there only one answer? Can you figure it out?   "
},
{
  "id": "activities-4-2-2",
  "level": "2",
  ...
  "number": "2",
  "title": "",
  "body": "  What is a line? What is a linear equation? Try to think both algebraically and geometrically (on a graph)! (Save this answer - we'll come back to it.)   "
},
{
  "id": "activities-4-3-1",
  "level": "2",
...
},
{
  ...
  "number": "4",
  "title": "",
  "body": "  We'll now consider linear systems in three variables. An example of a linear equation in three variables is . A linear equation in three variables (think , , and ) is a plane. Here we'll use index cards, or pieces of paper, or whatever you have that looks like a flat surface, to study the solutions to systems of linear equations in three variables. Again, a solution to a system of linear equations is a point (or points) that satisfy all the equations, ie., an intersection.     Is it possible that there are no solutions to a system of two equations in three variables? If so, explain how or sketch an example.      Is it possible that the solutions to a system of two equations in three variables is a single point? If so, explain how or sketch an example.      If you are studying a system of two equations in three variables, what would you usually expect for the solution set?      If you are studying a system of three equations in three variables, what would you usually expect for the solution set?      If you are studying a system of four equations in three variables, what would you usually expect for the solution set?      Is it possible that the solutions to four equations in three unknowns form a line? Either sketch an example or state a reason why it can't happen.      Suppose we have a set of 500 linear equations in 10 unknowns. Which of the would you expect to hold?      Suppose we have a set of 10 linear equations in 500 unknowns. Which of the three possibilities would you expect to hold?      What happens to the size of the solution sets as we add more equations?    "
},
{
